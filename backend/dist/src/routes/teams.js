...
async function registerTeamRoutes(server) {
    ...
    server.post('/api/teams/:teamId/vaults/:vaultId/share', {
        ...
        try {
            ...
            const userPerms = (0, teamService_1.getPermissionsForRole)(membership.role);
    ...
    server.put('/api/teams/:teamId/vaults/:vaultId/permissions', {
        ...
        try {
            ...
            if (newRole !== targetMember.role) {
                await (0, teamService_1.updateTeamMemberRole)(teamId, user.id, memberId, newRole);
            }
            await (0, auditLogService_1.createAuditLog)({
                userId: user.id,
            ...
            return {
                ...
                member: {
                    ...
                    role: newRole,
                    permissions: (0, teamService_1.getPermissionsForRole)(newRole)
                }
            };
        }
        catch (error) {
