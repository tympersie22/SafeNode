      ...
      <section className="py-20 text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <motion.a
            ...
            className="inline-flex items-center gap-4 px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white text-lg font-semibold rounded-xl transition shadow-xl"
        ...
        <div className="max-w-6xl mx-auto px-4 space-y-16">
          ...
          <div>
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl border border-indigo-200 p-8">
              ...
              <Link
                to="/auth"
                className="inline-flex items-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg transition"
              >
