          ...
          >
            ...
            <div className="hidden md:flex items-center gap-6">
              <nav className="flex items-center gap-6" role="navigation" aria-label="Main navigation links">
                ...
                <Link
                  to="/security"
                  className="text-slate-600 dark:text-slate-900 dark:hover:text-slate-100 transition-colors duration-200 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-secondary-500 rounded px-2 py-1"
                >
                  Security
                </Link>
                <Link
