      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold">SafeNode</h3>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors text-sm">Download</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors text-sm">Status</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-800 mt-8 pt-8 text-center">
          <p className="text-slate-400 text-sm">
            © 2024 SafeNode. Open source • MIT License
          </p>
        </div>
      </div>
    </footer>
